...
namespace HospitalEndToEndTests.Pages
{
    public class LoginPage
    {
        ...
        public string PatientLoginURI { get { return "http://localhost:4200/home"; } }
        ...
        public void WaitUntilProfileRedirect()
        {
            var wait = new WebDriverWait(driver, new TimeSpan(0, 0, 10));
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.UrlContains("profile"));
        }
