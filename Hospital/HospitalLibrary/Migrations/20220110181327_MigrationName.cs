...
<<<<<<< HEAD:Hospital/HospitalLibrary/Migrations/20220118151858_MigrationName.cs
...
=======
                    ...
                    { 7, 1, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Operation room 1", 0, 1, "OS" },
>>>>>>> 15c0939 (refactor: created value objects):Hospital/HospitalLibrary/Migrations/20220110181327_MigrationName.cs
...
=======
                columns: new[] { "Id", "Discriminator", "IsActivated", "IsBlocked", "LoginType", "Password", "Token", "Username", "DoctorId", "Address", "City", "Country", "Email", "Phone", "DateOfBirth", "Gender", "Name", "ParentName", "Surname" },
                values: new object[] { "kristina", "Patient", true, false, 0, "kristinica", new Guid("601ccaa8-3a07-4a7c-89b9-9923e6bac8a7"), "kristina", null, "Sime Milosevica, 9", "Novi Sad", "Serbia", "sdjfsj@gmail.com", "019919195191", new DateTime(1999, 11, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "male", "Kristina", "Zoran", "Tamindzija" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Discriminator", "IsActivated", "IsBlocked", "LoginType", "Password", "Token", "Username", "RoomId", "Specialization", "UsedOffDays", "Address", "City", "Country", "Email", "Phone", "DateOfBirth", "Gender", "Name", "ParentName", "Surname" },
                values: new object[] { "mkisic", "Doctor", false, false, 2, "ftn", new Guid("00000000-0000-0000-0000-000000000000"), "mkisic", 7, 0, 12, "Sime Milutinovica, 2", "Novi Sad", "Serbia", "nemanjar@gmail.com", "019919199191", new DateTime(1999, 7, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "male", "Mihajlo", "Zvezdan", "Kisic" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Discriminator", "IsActivated", "IsBlocked", "LoginType", "Password", "Token", "Username", "DoctorId", "Address", "City", "Country", "Email", "Phone", "DateOfBirth", "Gender", "Name", "ParentName", "Surname" },
                values: new object[] { "imbiamba", "Patient", false, false, 0, "pecurkaa", new Guid("601ccaa8-3a07-4a7c-89b9-9953e6eac8a7"), "imbiamba", null, "Sime Milosevica, 5", "Novi Sad", "Serbia", "markoilic@gmail.com", "019919199191", new DateTime(2001, 11, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "male", "Marko", "Milan", "Ilic" });
>>>>>>> 15c0939 (refactor: created value objects):Hospital/HospitalLibrary/Migrations/20220110181327_MigrationName.cs

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Discriminator", "IsActivated", "IsBlocked", "LoginType", "Password", "Token", "Username", "RoomId", "Specialization", "UsedOffDays", "Address", "City", "Country", "Email", "Phone", "DateOfBirth", "Gender", "Name", "ParentName", "Surname" },
                values: new object[] { "nelex", "Doctor", false, false, 2, "najjacapecurka", new Guid("00000000-0000-0000-0000-000000000000"), "nelex", 1, 3, 12, "Sime Milutinovica, 2", "Novi Sad", "Serbia", "nemanjar@gmail.com", "019919199191", new DateTime(1999, 7, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "male", "Nemanja", "Zoran", "Radojcic" });

            migrationBuilder.InsertData(
                table: "MedicalRecords",
                columns: new[] { "PatientId", "DoctorId", "BloodType", "Height", "PersonalId", "Profession", "Weight" },
                values: new object[,]
                {
                    { "imbiamba", "nelex", 4, 186, "1209001129123", "Professor", 90 },
                    { "kristina", "nelex", 6, 186, "1209222129123", "Professor", 90 }
                });
...
>>>>>>> 15c0939 (refactor: created value objects):Hospital/HospitalLibrary/Migrations/20220110181327_MigrationName.cs
            ...
            migrationBuilder.InsertData(
                table: "Visits",
                columns: new[] { "Id", "DoctorId", "PatientId", "VisitType", "IsCanceled", "IsReviewed", "EndTime", "StartTime" },
                values: new object[] { -1, "nelex", "imbiamba", 0, false, false, new DateTime(2021, 11, 30, 19, 30, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 11, 30, 19, 0, 0, 0, DateTimeKind.Unspecified) });
