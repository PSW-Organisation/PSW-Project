...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalLibrary.DoctorSchedule.Model.DoctorsSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HospitalLibrary.Events.Model.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 19, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -2,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 19, 0, 30, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -3,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 19, 1, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -4,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 19, 1, 30, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -5,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 19, 2, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -6,
                            ...
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 20, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -7,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 20, 1, 10, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -8,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 20, 2, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -9,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 20, 2, 4, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = -10,
                            ...
                            EventGuid = new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"),
                            IdUser = "imbiamba",
                            TimeStamp = new DateTime(2021, 12, 29, 20, 10, 0, 0, DateTimeKind.Unspecified)
                        });
                });

            modelBuilder.Entity("HospitalLibrary.Events.Model.EventMoveEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HospitalLibrary.Shared.Model.AppointmentPrescription", b =>
                {
                    ...
                    b.Property<double>("RecommendedDose")
                        .HasColumnType("double precision");
                    ...
                    b.HasData(
                        ...
                        {
                            AppointmentId = -1,
                            Date = new DateTime(2021, 11, 30, 19, 30, 0, 0, DateTimeKind.Unspecified),
                            Diagnosis = "J00 - Acute nasopharyngitis (common cold)",
                            DoctorUsername = "nelex",
                            Medicine = "Amoxiciline",
                            PatientUsername = "imbiamba",
                            Quantity = 120.0,
                            RecommendedDose = 50.0
                        });
                });

            modelBuilder.Entity("HospitalLibrary.Shared.Model.AppointmentReport", b =>
                {
                    b.Property<int>("AppointmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HospitalLibrary.DoctorSchedule.Model.DoctorsSchedule", b =>
                {
                    b.OwnsMany("HospitalLibrary.DoctorSchedule.Model.DoctorVacation", "DoctorVacations", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                            ...
                            b1.Property<int>("DoctorsScheduleId")
                                .HasColumnType("integer");

                            b1.HasKey("Id");

                            b1.HasIndex("DoctorsScheduleId");
                            ...
                            b1.OwnsOne("HospitalLibrary.RoomsAndEquipment.Terms.Utils.TimeInterval", "DateSpecification", b2 =>
                                {
                                    b2.Property<int>("DoctorVacationId")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("integer")
                                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                                    ...
                                    b2.HasKey("DoctorVacationId");

                                    b2.ToTable("DoctorVacations");
                    ...
                    b.OwnsMany("HospitalLibrary.DoctorSchedule.Model.OnCallShift", "OnCallShifts", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
