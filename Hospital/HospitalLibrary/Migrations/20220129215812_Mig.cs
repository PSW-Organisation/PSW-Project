        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendedDose = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentPrescriptions", x => x.AppointmentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventClass = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoveEquipmentEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reports", x => x.AppointmentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<string>(nullable: true),
                    DoctorsScheduleId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorVacations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorVacations_Schedules_DoctorsScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OnCallShifts_Schedules_DoctorsScheduleId",
                        column: x => x.DoctorsScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "AppointmentId", "Date", "Diagnosis", "DoctorUsername", "Medicine", "PatientUsername", "Quantity", "RecommendedDose" },
                values: new object[] { -1, new DateTime(2021, 11, 30, 19, 30, 0, 0, DateTimeKind.Unspecified), "J00 - Acute nasopharyngitis (common cold)", "nelex", "Amoxiciline", "imbiamba", 120.0, 50.0 });

            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "Duration", "EventAppName", "EventClass", "EventGuid", "IdUser", "TimeStamp" },
                values: new object[,]
                {
                    { -10, 0f, 1, "AppointmentSchedulingThirdStep", new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"), "imbiamba", new DateTime(2021, 12, 29, 20, 10, 0, 0, DateTimeKind.Unspecified) },
                    { -9, 0f, 1, "AppointmentSchedulingFourthStep", new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"), "imbiamba", new DateTime(2021, 12, 29, 20, 2, 4, 0, DateTimeKind.Unspecified) },
                    { -8, 0f, 1, "AppointmentSchedulingThirdStep", new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"), "imbiamba", new DateTime(2021, 12, 29, 20, 2, 0, 0, DateTimeKind.Unspecified) },
                    { -6, 0f, 1, "AppointmentSchedulingStart", new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"), "imbiamba", new DateTime(2021, 12, 29, 20, 0, 0, 0, DateTimeKind.Unspecified) },
                    { -7, 0f, 1, "AppointmentSchedulingSecondStep", new Guid("c8021183-2a36-2e33-9cab-ab1333f1af84"), "imbiamba", new DateTime(2021, 12, 29, 20, 1, 10, 0, DateTimeKind.Unspecified) },
                    { -4, 0f, 1, "AppointmentSchedulingFourthStep", new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"), "imbiamba", new DateTime(2021, 12, 29, 19, 1, 30, 0, DateTimeKind.Unspecified) },
                    { -3, 0f, 1, "AppointmentSchedulingThirdStep", new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"), "imbiamba", new DateTime(2021, 12, 29, 19, 1, 0, 0, DateTimeKind.Unspecified) },
                    { -2, 0f, 1, "AppointmentSchedulingSecondStep", new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"), "imbiamba", new DateTime(2021, 12, 29, 19, 0, 30, 0, DateTimeKind.Unspecified) },
                    { -1, 0f, 1, "AppointmentSchedulingStart", new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"), "imbiamba", new DateTime(2021, 12, 29, 19, 0, 0, 0, DateTimeKind.Unspecified) },
                    { -5, 0f, 1, "AppointmentSchedulingComplete", new Guid("c8021183-2a36-2e33-9cab-ab1329f1af84"), "imbiamba", new DateTime(2021, 12, 29, 19, 2, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                table: "MoveEquipmentEvents",
                columns: new[] { "Id", "DestinationRoomID", "IdUser", "NameOfEquipment", "SourceRoomID", "TimeStamp" },
                values: new object[,]
                {
                    { -6, 3, "jagodica", "bed", 2, new DateTime(2021, 12, 29, 20, 0, 0, 0, DateTimeKind.Unspecified) },
                    { -4, 6, "jagodica", "bed", 4, new DateTime(2021, 12, 29, 19, 1, 30, 0, DateTimeKind.Unspecified) },
                    { -3, 6, "jagodica", "bed", 4, new DateTime(2021, 12, 29, 19, 1, 0, 0, DateTimeKind.Unspecified) },
                    { -2, 2, "jagodica", "needle", 1, new DateTime(2021, 12, 29, 19, 0, 30, 0, DateTimeKind.Unspecified) },
                    { -1, 2, "jagodica", "needle", 1, new DateTime(2021, 12, 29, 19, 0, 0, 0, DateTimeKind.Unspecified) },
                    { -5, 6, "jagodica", "bed", 4, new DateTime(2021, 12, 29, 19, 2, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "AppointmentId", "Anamnesis", "Date", "Diagnosis", "DoctorUsername", "Notes", "PatientUsername" },
                values: new object[] { -1, "Patient exhibits common cold symptoms such as: nasal congestion, sneezing and runny nose.", new DateTime(2021, 11, 30, 19, 30, 0, 0, DateTimeKind.Unspecified), "J00 - Acute nasopharyngitis (common cold)", "nelex", "Patient is advised to drink plenty of fluids and make use of nasal drops or sprays.", "imbiamba" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "imbiamba", "Sime Milosevica, 5", "Novi Sad", "Serbia", new DateTime(2001, 11, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Patient", "markoilic@gmail.com", "male", true, false, 0, "Marko", "Milan", "pecurkaa", "019919199191", "Ilic", new Guid("601ccaa8-3a07-4a7c-89b9-9953e6eac8a7"), "imbiamba", null });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Description", "DoctorId", "DoctorsScheduleId", "EndTime", "StartTime" },
                values: new object[,]
                {
                    { 1, "Zimovanje", "mkisic", 1, new DateTime(2022, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "Bolovanje", "mkisic", 1, new DateTime(2022, 1, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 1, 25, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Letovanje", "nelex", 2, new DateTime(2022, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                table: "OnCallShifts",
                columns: new[] { "Id", "Date", "DoctorId", "DoctorsScheduleId" },
                values: new object[,]
                {
                    { 1, new DateTime(2022, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "mkisic", 1 },
                    { 3, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "mkisic", 1 },
                    { 2, new DateTime(2022, 1, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "nelex", 2 },
                    { 4, new DateTime(2022, 1, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "nelex", 2 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorVacations_DoctorsScheduleId",
                table: "DoctorVacations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnCallShifts_DoctorsScheduleId",
                table: "OnCallShifts",
                column: "DoctorsScheduleId");
