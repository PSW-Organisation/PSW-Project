...
namespace HospitalLibrary.RoomsAndEquipment.Terms.Service
{
    public class TermOfRenovationService : ITermOfRenovationService
    {
        ...
        public TermOfRenovation CreateTermsOfRenovation(TermOfRenovation termOfRenovation)
        {
            ...
            List<TimeInterval> termForRelocation = GetFreePossibleTermsOfRenovation(new ParamsOfRenovation(termOfRenovation.TimeInterval.StartTime, termOfRenovation.TimeInterval.EndTime, termOfRenovation.DurationInMinutes, termOfRenovation.IdRoomA, termOfRenovation.IdRoomB));
        ...
        public bool CancelRenovationTerm(int id)
        {
            ...
            if (_termsUtils.IsCancelAllowed(termOfRenovation.TimeInterval.StartTime))
            {
