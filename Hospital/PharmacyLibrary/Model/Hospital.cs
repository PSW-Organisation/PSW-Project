...
namespace PharmacyAPI.Model
{
    public class Hospital
    {
        ...
        public Hospital() { }
        public Hospital(long hospitalId, string hospitalUrl, string hospitalName, string hospitalAddress, string hospitalApiKey, string pharmacyApiKey, string email)
        {
